...
public final class JacksonUtils {
	...
	public static String getStrFromJsonObject(JSONObject jsonObject) throws Exception {
		return getStrFromJsonObject(jsonObject, 0);
	}
	
	public static String getStrFromJsonObject(JSONObject jsonObject, int indent) throws Exception {
		return jsonObject.toString(indent);
	}
	
	public static JSONArray getJsonArray(String strJson) throws Exception {
		return new JSONArray(strJson);
	}
	
	public static String getStrFromJsonArray(JSONArray jsonArray) throws Exception {
		return getStrFromJsonArray(jsonArray, 0);
	}
	
	public static String getStrFromJsonArray(JSONArray jsonArray, int indent) throws Exception {
