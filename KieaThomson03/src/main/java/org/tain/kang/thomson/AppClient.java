...
public final class AppClient implements OmmConsumerClient {
	...
	private void decode(Map map) throws Exception {
	...
	private void decode(FieldList fieldList, Object closuer) throws Exception {
		...
		if (flag) {
			...
			if (flag && _udpEnable && senderMessage != null) {
				...
				UdpSender.multiSend(bean.getGuid(), senderMessage);
			}
		}
